...
(function( $, window, document, undefined ) {
	var ElevateZoom = {
			...
			startZoom: function( ) {
				...
				self.zoomContainer = $('<div class="zoomContainer" style="-webkit-transform: translateZ(0);position:absolute;z-index:10;left:'+self.nzOffset.left+'px;top:'+self.nzOffset.top+'px;height:'+self.nzHeight+'px;width:'+self.nzWidth+'px;"></div>');
